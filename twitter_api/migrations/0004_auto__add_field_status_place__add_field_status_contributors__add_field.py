...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('twitter_api_status', 'place')

        # Deleting field 'Status.contributors'
        db.delete_column('twitter_api_status', 'contributors')

        # Deleting field 'Status.coordinates'
        db.delete_column('twitter_api_status', 'coordinates')

        # Deleting field 'Status.geo'
        db.delete_column('twitter_api_status', 'geo')
